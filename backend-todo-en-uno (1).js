...
async function ejecutarScrapingYGuardar() {
  ...
  // una sola vez y rápido (sin esperas artificiales), esto casi nunca se
  // debería alcanzar — pero si hay MUCHÍSIMOS juegos pendientes a la vez (o
  // la fuente está respondiendo lenta esa noche), esto evita que una corrida
  // se dispare a varios minutos sin control.
  const LIMITE_GLOBAL_CORRIDA_MS = 2 * 60 * 1000; // tope de 2 minutos, de sobra
