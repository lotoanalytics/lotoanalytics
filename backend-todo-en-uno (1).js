...
const FUENTES = [
  ...
  },
  {
    ...
    // Lotería Nacional (noche) — necesita el MÁS TARDÍO de los dos, por eso
    // sí se queda en 21 (depende del sorteo nocturno de Lotería Nacional).
  ...
  },
  {
    ...
    // Confirmado por fuente pública: "el Loto y el Loto Pool juegan en días
    // específicos de la semana, no a diario" — pero sin decir CUÁLES días.
    // Falta ese dato para poder agregar diasSorteoRD; mientras tanto sigue
    // expuesto al mismo bug de fecha fantasma que Mega Lotto.
  },
  {
    loteria: 'LoteDom',
