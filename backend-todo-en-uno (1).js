...
const FUENTES = [
  {
    ...
    horaSorteoRD: 21, // sorteo nocturno de Lotería Nacional (~8:55/9:00 PM)
  },
  {
    loteria: 'Lotería Nacional',
    juego: 'Juega + Pega +',
    ...
    horaSorteoRD: 21, // mismo sorteo nocturno de Lotería Nacional
  },
  {
    loteria: 'Lotería Nacional',
    ...
    horaSorteoRD: 21, // sorteo nocturno — este es el juego donde se detectó el bug
  },
  {
    loteria: 'Leidsa',
    juego: 'Súper Kino TV',
    url: CONFIG.fuenteBaseUrl + '/leidsa/super-kino-tv/',
    // Sortea varias veces al día — sin una sola hora fija, se deja sin horaSorteoRD.
  },
  {
    loteria: 'Loteka',
    ...
    horaSorteoRD: 21, // sorteo nocturno de Loteka (~8:55/9:00 PM)
  },
  {
    loteria: 'Lotería Real',
    juego: 'Quiniela',
    url: CONFIG.fuenteBaseUrl + '/loto-real/quiniela/',
    horaSorteoRD: 21, // sorteo nocturno de Lotería Real (~9:00 PM)
  },
  {
    loteria: 'Lotería Real',
    juego: 'Tu Fecha Real',
    ...
    horaSorteoRD: 21, // sale junto con la Quiniela Real nocturna
  },
  {
    loteria: 'Lotería Real',
  ...
  },
  {
    ...
    horaSorteoRD: 20, // depende de Chance Real (8:00 PM)
  },
  {
    loteria: 'Lotería Real',
    juego: 'Chance Real',
  ...
  },
  {
    ...
    horaSorteoRD: 21, // depende de ambos sorteos nocturnos
  },
  {
  ...
  },
  {
    ...
    horaSorteoRD: 21, // sorteo nocturno de LoteDom
  },
  {
  ...
  },
  {
    ...
    // Hora exacta no confirmada — se deja sin horaSorteoRD por ahora.
  },
  {
    loteria: 'Leidsa',
    juego: 'Pega 3 Más',
    url: CONFIG.fuenteBaseUrl + '/leidsa/pega-3-mas/',
    horaSorteoRD: 21, // sale junto con el sorteo nocturno de Leidsa
  },
  {
    loteria: 'Leidsa',
  ...
  },
  {
    ...
    horaSorteoRD: 21, // sorteo nocturno de Loteka
  },
  {
    loteria: 'Loteka',
    ...
    horaSorteoRD: 21, // depende de Mega Chances
  },
  {
    loteria: 'Loteka',
    juego: 'Toca 3',
  ...
  },
  {
    ...
    // Sorteo semanal (no diario) — se deja sin horaSorteoRD por ahora.
  },
  {
    loteria: 'Lotería Real',
    juego: 'Loto Real',
  ...
  },
  {
    ...
    horaSorteoRD: 21, // depende de la Quiniela LoteDom nocturna
  },
  {
    loteria: 'LoteDom',
    juego: 'Agarra 4',
...
// horaMinimaRD: hora (0-23 RD) a partir de la cual se puede confiar en que
...
// para todos.
function normalizarFecha(textoFecha, horaSorteoRD) {
  const resultado = normalizarFechaBruta(textoFecha);
  const horaMinimaRD = (typeof horaSorteoRD === 'number') ? horaSorteoRD : 7;
  ...
  if (resultado === fechaHoyRD() && horaActualRD() < horaMinimaRD) {
...
async function normalizarFechaConVerificacion(textoFecha, loteria, juego, numeros, horaSorteoRD) {
  const fechaCalculada = normalizarFecha(textoFecha, horaSorteoRD);
...
async function extraerUnaFuenteConPuppeteer(browser, fuente) {
  ...
  return {
    ...
    juego: fuente.juego,
    fecha: await normalizarFechaConVerificacion(textoFecha, fuente.loteria, fuente.juego, numeros, fuente.horaSorteoRD),
    numeros: numeros,
