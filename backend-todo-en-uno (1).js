...
const FUENTES = [
  ...
  },
  {
    ...
    // Sorteo semanal (no diario) — SIN CONFIRMAR qué día de la semana sortea.
    // Cuando se sepa, agregar diasSorteoRD: [n] igual que se hizo con Loto
    // Leidsa. Mientras tanto sigue expuesto al mismo bug de fecha fantasma.
  },
  {
    loteria: 'Lotería Real',
    juego: 'Loto Real',
  ...
  // patrón de fecha fantasma reapareciendo solo en esos juegos.
  {
    ...
    horaSorteoRD: 15, // NY Numbers Midday, ~2:30 PM hora del este (mismo huso que RD en horario de verano)
  },
  {
    loteria: 'Lotería New York',
  ...
  },
  {
    ...
    horaSorteoRD: 14, // Florida Pick Midday, ~1:30 PM hora del este
  },
  {
    loteria: 'Florida',
