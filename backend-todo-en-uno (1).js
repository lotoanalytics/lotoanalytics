...
const FUENTES = [
  {
    ...
    selectores: {
      contenedorUltimoResultado: '.game-block, .game-scores, .resultado-reciente, .card-resultado, .game-details, .game-content, body',
      numeros: '.score, .bola, .numero-ganador, .ball, span.score, .game-scores span, .game-block span',
      fecha: '.game-date, .fecha-sorteo, time, .date, .session-date',
    },
  },
  {
    loteria: 'Leidsa',
